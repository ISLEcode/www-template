<script>
// Forked from: https://github.com/agustinl/svelte-tags-input
// Should be merged with Sveltstrap's Input.svelte as `type="tags"`
...
let regExpEscape = (s) => { return s.replace(/[-\\^$*+?.()|[\]{}]/g, "\\$&") }
