    ...
    <Row>
      ...
      <Col class="col-12 col-md-6">
        <FormGroup class="form-floating">
          ...
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-name">Nom</Label>
      ...
      {#if $qrbill.creditor.addrtype === 'S'}
        <Col class="col-12 col-md-9">
          <FormGroup class="form-floating">
            ...
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-addr1">Rue</Label>
        ...
        <Col class="col-12 col-md-3">
          <FormGroup class="form-floating">
            ...
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-addr1">Numéro</Label>
      ...
      {:else}
        <Col class="col-12">
          <FormGroup class="form-floating">
            <Input id="creditor-addr1" class="{input_ok}" type="text" bind:value={$qrbill.creditor.addr1}
              placeholder="Rue du Lac" readonly={!$qrbill.ux.editable} />
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-addr1">Adresse #1</Label>
            <div class="invalid-feedback">Rue/Case postale du bénéficiaire — 70 caractères au maximum admis
            — Ne peut pas contenir un numéro de maison ou de bâtiment.</div>
          </FormGroup>
        </Col>
        <Col class="col-12">
          <FormGroup class="form-floating">
            <Input id="creditor-addr2" class="{input_ok}" type="text" bind:value={$qrbill.creditor.addr2}
              placeholder="1268" readonly={!$qrbill.ux.editable} />
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-addr1">Adresse #2</Label>
            <div class="invalid-feedback">Numéro de maison du bénéficiaire — 16 caractères au maximum admis</div>
          </FormGroup>
        </Col>
      {/if}
    ...
    <Row>
      <Col class="col-12 col-md-2">
        <FormGroup class="form-floating">
          ...
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-postcode">NPA</Label>
      ...
      <Col class="col-12 col-md-6">
        <FormGroup class="form-floating">
          ...
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-location">Lieu</Label>
      ...
      <Col class="col-12 col-md-4">
        <FormGroup class="form-floating">
          <Input id="creditor-country" class="{input_ok}" type="select" bind:value={$qrbill.creditor.country}
            placeholder="CH" disabled={!$qrbill.ux.editable}><Countries selected={$qrbill.creditor.country}/></Input>
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="creditor-country">Pays</Label>
