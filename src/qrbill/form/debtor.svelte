    ...
    <Row>
      <Col class="col-12 col-md-6">
        <FormGroup class="form-floating">
          <Input id="debtor-iban" class="{input_ok}" type="text" bind:value={$qrbill.debtor.iban}
            placeholder="CH4431999123000889012" readonly={!$qrbill.ux.editable} />
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-iban">Compte</Label>
      ...
      <Col class="col-12 col-md-6">
        <FormGroup class="form-floating">
          ...
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-name">Nom</Label>
      ...
      {#if $qrbill.debtor.addrtype === 'S'}
        <Col class="col-12 col-md-9">
          <FormGroup class="form-floating">
            ...
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-addr1">Rue</Label>
        ...
        <Col class="col-12 col-md-3">
          <FormGroup class="form-floating">
            ...
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-addr2">Numéro</Label>
      ...
      {:else}
        <Col class="col-12">
          <FormGroup class="form-floating">
            <Input id="debtor-addr1" class="{input_ok}" type="text" bind:value={$qrbill.debtor.addr1}
              placeholder="Rue du Lac" readonly={!$qrbill.ux.editable} />
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-addr1">Adresse #1</Label>
            <div class="invalid-feedback">Rue/Case postale du débiteur final — 70 caractères au maximum admis
            — Ne peut pas contenir un numéro de maison ou de bâtiment.</div>
          </FormGroup>
        </Col>
        <Col class="col-12">
          <FormGroup class="form-floating">
            <Input id="debtor-addr2" class="{input_ok}" type="text" bind:value={$qrbill.debtor.addr2}
              placeholder="1268" readonly={!$qrbill.ux.editable} />
            <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-addr2">Adresse #1</Label>
            <div class="invalid-feedback">Numéro de maison du débiteur final — 16 caractères au maximum admis</div>
          </FormGroup>
        </Col>
      {/if}
    ...
    <Row>
      <Col class="col-12 col-md-2">
        <FormGroup class="form-floating">
          ...
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-postcode">NPA</Label>
      ...
      <Col class="col-12 col-md-6">
        <FormGroup class="form-floating">
          ...
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-location">Lieu</Label>
      ...
      <Col class="col-12 col-md-4">
        ...
        <FormGroup class="form-floating">
          <Input id="debtor-country" class="{input_ok}" type="select" bind:value={$qrbill.debtor.country}
            placeholder="CH" disabled={!$qrbill.ux.editable}><Countries selected={$qrbill.debtor.country}/></Input>
          <Label class={$qrbill.ux.editable ? '' : 'form-control-plaintext'} for="debtor-country">Pays</Label>
