<script lang="ts">
  import { Button, Col, Container, Icon, Row } from 'sveltestrap5';

  import PrismCode from './__code.svelte';
  import Example from './__example.svelte';
  import Sample from './welcome-sample.svelte';
  import Sample_src from './welcome-sample.svelte';
</script>
...
<div>
  ...
  <Container>
    <Row class="justify-content-sm-center">
      <Col sm={8} class="docSearch-content">
        <Example source={Sample_src} stacked>
          <Sample />
        </Example>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css">
        ...
        <h6>or use the <Button color="link" class="p-0" style="vertical-align: unset;">Styles</Button> component:</h6>
        <pre>
          <PrismCode class="language-html">
            {`<script>
    import { Styles } from 'sveltestrap5';
</script>
<Styles />`}
          </PrismCode>
        </pre>
        ...
        <h4>Note on Icons</h4>
        <p>
          If you wish to use the <Button color="link" class="p-0" style="vertical-align: unset;">Icon</Button> component, you also must include a link to Bootstrap Icon CSS, for example:
        </p>
        <pre>
          <PrismCode class="language-html">
            {`<svelte:head>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css">
          ...
          or the <Button color="link" class="p-0" style="vertical-align: unset;">Styles</Button> component includes the Bootstrap Icon CSS by default:
        <pre>
          <PrismCode class="language-html">
            {`<script>
    import { Styles } from 'sveltestrap5';
